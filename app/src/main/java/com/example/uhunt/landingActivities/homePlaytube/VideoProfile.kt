...
//                                color = Color.White
            ...
            courselist = (courselist + Clist("Download", R.drawable.download_ic)) as ArrayList<Clist>
            courselist = (courselist + Clist("Save", R.drawable.savetrailer_ic)) as ArrayList<Clist>
            courselist = (courselist + Clist("Trailer", R.drawable.savetrailer_ic)) as ArrayList<Clist>
...
//                            contentColor = Color.White,
                        ...
                        Row {
                            ...
                            Text(text = courselist[index].languagename,
                                style = TextStyle(
                                    fontSize = 13.sp,
...
//                        color = Color.White,
                ...
                Text(text = ".60",
                    style = TextStyle(
                        fontSize = 13.sp, color = Color(android.graphics.Color.parseColor("#AAAAAA")),
                        fontFamily = FontFamily(Font(R.font.roboto_regular))
                    ), modifier = Modifier
                        .padding(start = 8.dp)
                        .width(14.dp)
            ...
            Row() {
                ...
                Text(text = "Write a comment ...", style = TextStyle(
                    fontSize = 15.sp,
                    color = androidx.compose.ui.graphics.Color.White,
                    fontFamily = FontFamily(Font(R.font.roboto_bold))
                ) ,modifier = Modifier
...
//
            ...
            courselist2 = (courselist2 + Clist("Jesse Farr", R.drawable.video_thumbnail)) as ArrayList<Clist>
            courselist2 = (courselist2 + Clist("Joey Sir", R.drawable.video_thumbnail)) as ArrayList<Clist>
            courselist2 = (courselist2 + Clist("Matt Sandford", R.drawable.video_thumbnail)) as ArrayList<Clist>
            courselist2 = (courselist2 + Clist("Sally Richards", R.drawable.video_thumbnail)) as ArrayList<Clist>
            courselist2 = (courselist2 + Clist("Joey Sir", R.drawable.video_thumbnail)) as ArrayList<Clist>
            courselist2 = (courselist2 + Clist("Kevin Scotch", R.drawable.video_thumbnail)) as ArrayList<Clist>
            courselist2 = (courselist2 + Clist("Sam Bensan", R.drawable.video_thumbnail)) as ArrayList<Clist>
            courselist2 = (courselist2 + Clist("Joey Sir", R.drawable.video_thumbnail)) as ArrayList<Clist>
...
//                     Spacer(modifier = Modifier.width(5.dp))
                                Column(modifier = Modifier.weight(4f)) {
                                    Row(modifier = Modifier.padding(end = 10.dp).align(Alignment.CenterHorizontally)) {
//                                        Text(
